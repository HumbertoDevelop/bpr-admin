            ...
            {hasMounted && (
              <Form onSubmit={handleSubmit}>
                ...
                <Row>
                  {/* Phone number */}
                  <Col xl={6} lg={6} xs={12} md={12}>
                    <Form.Group className="mb-3" controlId="player_phone_number">
                      <Form.Label>
                        Numero de teléfono{" "}
                        <span style={{ color: "#FF0000" }}>*</span>
                      </Form.Label>
                ...
                <Row>
                  <Col xl={6} lg={6} xs={12} md={12}>
                    {/* # Born country */}
                    <Form.Group className="mb-3" controlId="player_born_country">
                      <Form.Label>
                        Pais de nacimiento{" "}
                        <span style={{ color: "#FF0000" }}>*</span>
                      </Form.Label>
                ...
                <Row>
                  <Col xl={6} lg={6} xs={12} md={12}>
                    {/* # Residence country */}
                    <Form.Group className="mb-3" controlId="player_residence_country">
                      <Form.Label>
                        Pais de residencia{" "}
                        <span style={{ color: "#FF0000" }}>*</span>
                      </Form.Label>
                ...
                <Col xl={3} lg={3} xs={3} md={3}>
                    ...
                    >
                      ...
                      >
                        <Form.Check.Input type="checkbox" name="player_approved" />
