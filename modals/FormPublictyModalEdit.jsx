...
export default function FormPublicityModalEdit(props) {
  ...
  // Modal confirm
  const ConfirmModalDelete = React.memo((props) => {
    return (
      <Fragment>
        <Modal show={showDelete}>
          ...
          <Modal.Body>Eliminar Publicidad</Modal.Body>
          <Modal.Footer>
  ...
  ConfirmModalDelete.displayName = "ConfirmModalDelete";
  ...
  return (
    <>
      ...
      >
        <ConfirmModal
          descriptionModal={"Esta seguro que desea editar esta publicidad?"}
