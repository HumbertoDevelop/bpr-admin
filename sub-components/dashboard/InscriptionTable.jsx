...
import FormInscriptionsModalEdit from "modals/FormInscriptionsModalEdit";
...
const InscriptionTable = () => {
    ...
    return (
      <Fragment>
        <Modal show={show}>
          ...
          <Modal.Body>Eliminar Inscripción</Modal.Body>
          <Modal.Footer>
  ...
  return (
    <Card className="h-100">
      <FormInscriptionsModalEdit
        show={modalShow}
        onHide={() => setModalShow(false)}
        buttonText={"Editar"}
        titleModal={"Editar Inscripción"}
      />
      <ConfirmModal />
      <Container>
        <Row className="mt-4">
          <Card.Header className="bg-white py-4">
            <h4 className="mb-0">Inscripciones registradas </h4>
          </Card.Header>
...
export default React.memo(InscriptionTable);
