...
import FormManagerModalEdit from "modals/FormManagerModalEdit";
...
const ManagerTable = () => {
    ...
    return (
      <Fragment>
        <Modal show={show}>
          ...
          <Modal.Body>Eliminar Organizador</Modal.Body>
          <Modal.Footer>
  ...
  return (
    <Card className="h-100">
      <FormManagerModalEdit
        show={modalShow}
        onHide={() => setModalShow(false)}
        buttonText={"Editar"}
        titleModal={"Editar Manager"}
      />
      <ConfirmModal />
      <Container>
        <Row className="mt-4">
          <Card.Header className="bg-white py-4">
            <h4 className="mb-0">Organizadores registrados </h4>
          </Card.Header>
