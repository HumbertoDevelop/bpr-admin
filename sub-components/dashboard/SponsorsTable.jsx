...
import FormSponsorModalEdit from "modals/FormSponsorModalEdit";
...
const SponsorTable = () => {
    ...
    return (
      <Fragment>
        <Modal show={show}>
          ...
          <Modal.Body>Eliminar Patrocinante</Modal.Body>
          <Modal.Footer>
  ...
  return (
    <Card className="h-100">
      <FormSponsorModalEdit
        show={modalShow}
        onHide={() => setModalShow(false)}
        buttonText={"Editar"}
        titleModal={"Editar Patrocinante"}
      />
      <ConfirmModal />
      <Container>
        <Row className="mt-4">
          <Card.Header className="bg-white py-4">
            <h4 className="mb-0">Patrocinantes registrados </h4>
          </Card.Header>
...
export default React.memo(SponsorTable);
