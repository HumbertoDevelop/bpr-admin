...
import FormTournamentsModalEdit from "modals/FormTournamentsModalEdit";
...
const TournamentsTable = () => {
    ...
    return (
      <Fragment>
        <Modal show={show}>
          ...
          <Modal.Body>Eliminar Torneo</Modal.Body>
          <Modal.Footer>
  ...
  return (
    <Card className="h-100">
      <FormTournamentsModalEdit
        show={modalShow}
        onHide={() => setModalShow(false)}
        buttonText={"Editar"}
        titleModal={"Editar Torneo"}
      />
      <ConfirmModal />
      <Container>
        <Row className="mt-4">
          <Card.Header className="bg-white py-4">
            <h4 className="mb-0">Torneo registrados </h4>
          </Card.Header>
...
export default React.memo(TournamentsTable);
