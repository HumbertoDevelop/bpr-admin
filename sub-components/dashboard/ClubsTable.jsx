...
import FormClubsModalEdit from "modals/FormClubsModalEdit";
    ...
    return (
      <Fragment>
        <Modal show={show}>
          ...
          <Modal.Body>Eliminar Club</Modal.Body>
          <Modal.Footer>
  ...
  return (
    <Card className="h-100">
      <FormClubsModalEdit
        ...
        buttonText={"Editar"}
        titleModal={"Editar Club"}
      />
      <ConfirmModal />
      <Container>
        <Row className="mt-4">
          <Card.Header className="bg-white py-4">
            <h4 className="mb-0">Clubes registrados </h4>
          </Card.Header>
...
export default React.memo(ClubTable);
