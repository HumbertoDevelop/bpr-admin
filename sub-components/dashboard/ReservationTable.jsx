...
import FormReservationsModalEdit from "modals/FormReservationsModalEdit";
...
const ReservationTable = () => {
    ...
    return (
      <Fragment>
        <Modal show={show}>
          ...
          <Modal.Body>Eliminar Reservación</Modal.Body>
          <Modal.Footer>
  ...
  return (
    <Card className="h-100">
      <FormReservationsModalEdit
        show={modalShow}
        onHide={() => setModalShow(false)}
        buttonText={"Editar"}
        titleModal={"Editar Reservación"}
      />
      <ConfirmModal />
      <Container>
        <Row className="mt-4">
          <Card.Header className="bg-white py-4">
            <h4 className="mb-0">Reservaciones registradas </h4>
          </Card.Header>
